...
import '../utils/article_factory.dart';
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: InkWell(
                onTap: () {
                  final articleEntity = ArticleFactory.convertFromMap(article);

                  NavigationService.navigateToWithObject(AppPages.details, articleEntity);
                },
                child: Column(
